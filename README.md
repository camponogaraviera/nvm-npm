...
# Environment Variables (Unix-like systems)

To set an env. variable to development mode, type in the terminal:

```bash
export NODE_ENV=development
```

To set an env. variable to production mode, type in the terminal:

```bash
export NODE_ENV=production
```

To simulate a dynamic port assigned by the host, type in the terminal:
